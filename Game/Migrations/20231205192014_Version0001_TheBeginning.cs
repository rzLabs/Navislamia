        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<int[]>(type: "integer[]", maxLength: 20, precision: 12, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Restriction = table.Column<short>(type: "smallint", nullable: false),
                    ...
                    BaseType = table.Column<short[]>(type: "smallint[]", maxLength: 2, nullable: true),
                    BaseVar = table.Column<decimal[,]>(type: "numeric[]", maxLength: 8, precision: 12, scale: 2, nullable: true),
                    OptType = table.Column<short[]>(type: "smallint[]", maxLength: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TooltipId = table.Column<int>(type: "integer", nullable: false),
                    Elemental = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    NeedTarget = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRidingOnly = table.Column<int>(type: "integer", nullable: false),
