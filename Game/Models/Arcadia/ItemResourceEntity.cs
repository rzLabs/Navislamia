...
using ItemGroup = DevConsole.Models.Arcadia.Enums.ItemGroup;
using ItemType = DevConsole.Models.Arcadia.Enums.ItemType;
using ItemWearType = DevConsole.Models.Arcadia.Enums.ItemWearType;
...
public class ItemResourceEntity : Entity
{
    ...
    public ItemDecreaseType DecreaseType { get; set; }
    ...
    public short JobDepth { get; set; } // might be an enum, not yet discovered
    ...
    public ItemEffectInstantType[] BaseType { get; set; } = new ItemEffectInstantType[2]; // Base item Type 
    ...
    public short CoolTimeGroup { get; set; } // unused? could not find related enum
