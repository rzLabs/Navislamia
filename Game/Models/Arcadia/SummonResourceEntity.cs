...
//TODO check nullable properties
...
public class SummonResourceEntity : Entity
{
	...
	public decimal Size { get; set; } // DECIMAL(10,2)
	public decimal Scale { get; set; } // DECIMAL(10,2)
	public decimal TargetFxSize { get; set; } // DECIMAL(10,2)
	...
	public decimal AttackRange { get; set; } // DECIMAL(10,2)
	...
	public EvolutionStage EvolutionStage { get; set; } // Formerly "Form"
	...
	public decimal TargetX { get; set; } // DECIMAL(10,2)
	public decimal TargetY { get; set; } // DECIMAL(10,2)
	public decimal TargetZ { get; set; } // DECIMAL(10,2)
